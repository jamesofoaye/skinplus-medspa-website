...
import {
  Container, SimpleGrid, Image, Flex, Heading, Box, Icon, Button, Link,
  Text, Stack, StackDivider, chakra, useColorModeValue, createIcon
  ...
  return (
    <>
        ...
        <Box bgColor={"brand.green"} minH={'100vh'}>
            ...
            <Container maxW={'8xl'} pb={12} pt={2}>
                <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
                    <Stack spacing={4}>
                        <Text color={'white'} fontSize={'xl'} lineHeight={9} mb={[28, 16]}>
                            Hello there!
                            <br />
                            This discount card entitles you to a {''} 
                            <chakra.span  color={'brand.sand'} fontSize={25}>10% discount</chakra.span> {''}
                            at Skinplus Medspa. Skinplus Medspa is an upscale physician run medspa in East Legon.
                            We perform minimally invasive cosmetic procedures. We are collaborating with Fatfish 
                            to bring you this opportunity to try any of our services at a discounted rate.
                            <br /> 
                        ...
                        <Heading fontFamily={'Lora'} color={'brand.sand'} textAlign={'center'}>
